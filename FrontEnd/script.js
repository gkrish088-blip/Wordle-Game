...
function createKeyMap(rowName) {
  const rowname = String(rowName);
  var row;
  if (rowname === "QWERTYUIOP") {
    row = 0;
  } else if (rowname === "ASDFGHJKL") {
    row = 1;
...
function startgame() {
  ...
  const trgW0r9 = selectTargetWord();
  createKeyMap("QWERTYUIOP");
  createKeyMap("ASDFGHJKL");
  createKeyMap("ZXCVBNM");
  createKeyMap("enter");
  return trgW0r9;
}
